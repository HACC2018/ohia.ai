...
@click.option('--n_hidden', default=1024, help='Number of hidden units in penultimate layer.')
@click.option('--dropout', default=0.00, help='Dropout rate.')
...
def main(model_name, n_hidden, dropout, seed, batch_size, filtered, augmentation, n_thread, gpu, save_model):
